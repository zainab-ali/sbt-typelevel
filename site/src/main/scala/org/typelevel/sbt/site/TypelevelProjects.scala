...
object TypelevelProject {
  ...
  val Fs2 = "fs2" -> uri("https://fs2.io/")
  val Http4s = "http4s" -> uri("https://http4s.org/")
  val Scalacheck = "scalacheck" -> uri("https://scalacheck.org/")
  val Shapeless = gh("shapeless", "milessabin")
  val Shapeless3 = gh("shapeless-3")

  private def tl(repo: String) = repo -> uri(s"https://typelevel.org/$repo/")
  private def gh(repo: String, user: String = "typelevel") =
    repo -> uri(s"https://github.com/$user/$repo/")
}
